...
model2 = load_model(path + 'keras30_ModelCheckPoint13_save_model.h5')
mae, mse = model2.evaluate(x_test, y_test)
print('mse : ', mse)
from sklearn.metrics import r2_score
...
model3 = load_model(path +'MCP/keras30_ModelCheckPoint13.hdf5')
mae, mse = model3.evaluate(x_test, y_test)
print('mse : ', mse)
from sklearn.metrics import r2_score
