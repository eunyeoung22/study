...
x_train = x_train.reshape(265,5,2,1)
x_test = x_test.reshape(88,5,2,1)
...
# drop2 = Dropout(0.2)(dence4)
# dence5 = Dense(100, activation= 'linear')(drop2)
# drop3 = Dropout(0.2)(dence5)
# dence6 = Dense(200, activation= 'linear')(drop3)
...
2D적용 후
loss :  [3980.19677734375, 52.770931243896484]
RMSE :  63.0887999602507
R2 :  0.34149714784596263
"""
