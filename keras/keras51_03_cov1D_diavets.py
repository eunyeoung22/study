...
from tensorflow.keras.layers import Dense, Input, Dropout,LSTM,Flatten,Conv1D
...
# 2. 모델 구성(순차형)
model = Sequential()
model.add(Conv1D(100, 2, input_shape=(5,2), activation= 'relu'))
...
loss :  [0.5914353132247925, 0.5862195491790771]
RMSE :  0.7690482715105783
R2 :  0.5755512875860216
