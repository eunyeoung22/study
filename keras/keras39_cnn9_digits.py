...
#2. 모델 구성(순차형)
model = Sequential()
model.add(Conv2D(100, (3,3), input_shape=(8,8,1), activation= 'relu'))
model.add(Flatten())
...
# drop1 = Dropout(0.4)(dence1) 
# dence2 = Dense(100, activation= 'linear')(drop1)
# drop2 = Dropout(0.2)(dence2) 
# dence3 = Dense(100, activation= 'linear')(drop2)
...
# drop6 = Dropout(0.5)(dence6)
# dence7 = Dense(100, activation= 'linear')(drop6)
