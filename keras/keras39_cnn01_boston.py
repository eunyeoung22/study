...
model.add(Dropout(0.5)) # 상위레이어 50% dropout할거야 
model.add(Dense(100, activation= 'sigmoid'))
model.add(Dropout(0.3)) # 상위레이어 30% dropout할거야
model.add(Dense(200, activation= 'linear'))
model.add(Dense(300, activation= 'linear'))
model.add(Dense(400, activation= 'linear'))
model.add(Dense(500, activation= 'linear'))
model.add(Dropout(0.2)) # 상위레이어 20% dropout할거야
model.add(Dense(400, activation= 'linear'))
model.add(Dense(300, activation= 'linear'))
model.add(Dense(200, activation= 'linear'))
...
# dence2 = Dense(100, activation= 'sigmoid')(drop1)
# drop2 = Dropout(0.3)(dence2)
# dence3 = Dense(200, activation= 'linear')(drop2)
...
# drop3 = Dropout(0.2)(dence8)
# dence9 = Dense(200, activation= 'linear')(drop3)
...
#                       filepath= filepath +'k31_01_'+ '_' + date + '_' + filename) #파일 저장 경로 지정                
...
"""
R2 스코어 :  0.7393079482088913
R2 스코어 :  0.7478851311123638
"""
